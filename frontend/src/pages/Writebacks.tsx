...
const Writebacks = () => {
  ...
  if (isLoading) {
    return <div className="text-center py-12">Loading writebacks...</div>;
  }
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900">Writebacks</h1>
      ...
      {machinesWithWritebacks.length > 0 ? (
        ...
        <div className="text-center py-12 bg-white rounded-lg shadow">
          ...
          <p className="text-gray-600 mb-2">No active writebacks</p>
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white rounded-lg shadow p-6">
          <p className="text-sm text-gray-600">Total Writebacks</p>
          <p className="text-3xl font-bold text-gray-900 mt-2">
            {machinesWithWritebacks.length}
          </p>
        </div>
        <div className="bg-white rounded-lg shadow p-6">
          <p className="text-sm text-gray-600">Total Writeback Size</p>
          <p className="text-3xl font-bold text-gray-900 mt-2">
            {formatBytes(
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <p className="text-sm text-gray-600">Persistent Writebacks</p>
          <p className="text-3xl font-bold text-gray-900 mt-2">
